...
% Input files:
genericSetupForIK = 'A03_Setup_IK.xml'; % Name of the IK setup XML file for the given trial (to be modified)
markerFile = 'A03_Pref_0007.trc'; % Name of the experimental walking marker data .trc file (single trial)
inputModel = 'A03_passive_autoScaled4.osim'; % Filename of input model (scaled, standard marker placement) 
...
% preSocketJointModel = [modelDir 'A03_passive_ROBPROS_auto_marker_place.osim'];
