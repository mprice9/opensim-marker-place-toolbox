...
% models{1} = 'A03_passive_FULL_auto_marker_place_RIGID_rigid_base.osim';
% models{2} = 'A03_passive_FULL_auto_marker_place_FLEXION_ONLY_rigid_base.osim';
% models{3} = 'A03_passive_FULL_auto_marker_place_PISTON_ONLY_rigid_base.osim';
...
% models{1} = 'A03_passive_FULL_auto_marker_place_RIGID_6dof_base_static_align.osim';
% models{2} = 'A03_passive_FULL_auto_marker_place_FLEXION_ONLY_6dof_base_static_align.osim';
% models{3} = 'A03_passive_FULL_auto_marker_place_PISTON_ONLY_6dof_base_static_align.osim';
% models{4} = 'A03_passive_FULL_auto_marker_place_FLEXION_PISTON_6dof_base_static_align.osim';
% models{5} = 'A03_passive_FULL_auto_marker_place_4DOF_6dof_base_static_align.osim';
% models{6} = 'A03_passive_FULL_auto_marker_place_6DOF_6dof_base_static_align.osim';

models{1} = 'A03_passive_FULL_auto_marker_place_RIGID_6dof_base_locked_z.osim';
models{2} = 'A03_passive_FULL_auto_marker_place_FLEXION_ONLY_6dof_base_locked_z.osim';
models{3} = 'A03_passive_FULL_auto_marker_place_PISTON_ONLY_6dof_base_locked_z.osim';
models{4} = 'A03_passive_FULL_auto_marker_place_FLEXION_PISTON_6dof_base_locked_z.osim';
models{5} = 'A03_passive_FULL_auto_marker_place_4DOF_6dof_base_locked_z.osim';
models{6} = 'A03_passive_FULL_auto_marker_place_6DOF_6dof_base_locked_z.osim';
...
% Model selection: 1 = SR1, 2 = SR2, 3 = SR2
% if other amputee models are used, modify to reflect models specified
% ModelBegin = 1;
% ModelEnd = 3;
...
% for ModelNumber = ModelBegin:ModelEnd
%     % Get the model
% 
%     
%     if ModelNumber == 1
%         modelFile = ([model_dir model1]);
%         NameMod = '_SR1';
%     end
%     if ModelNumber == 2
%         modelFile = ([model_dir model2]);
%         NameMod = '_SR2';
%     end
%     if ModelNumber == 3
%         modelFile = ([model_dir model3]);
%         NameMod = '_SR3';
%     end
...
%                 message = [num2str(time(line-18,1)) '\t' num2str(TSE(line-18,1)) '\t' num2str(RMS(line-18,1)) '\t' num2str(errMax(line-18,1)) '\n'];
%                 
%                 fprintf(fileID, message);
            end
