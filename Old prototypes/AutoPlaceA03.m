...
markerFile = [trcDataDir '\A03_Pref_0007.trc']; % Name of the experimental walking marker data .trc file (single trial)
...
model = 'A03_passive_autoScaled4.osim'; % Provide name of input model (scaled, standard marker placement) 
...
preSocketJointModel = [modelDir 'A03_passive_ROBPROS_auto_marker_place_6dof_base_orient.osim'];
