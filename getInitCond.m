...
x0(end+1) = sp.get(0);
testCoords{end+1} = 'SOCKET_JOINT_LOCATION_IN_PARENT x';
x0(end+1) = sp.get(1);
testCoords{end+1} = 'SOCKET_JOINT_LOCATION_IN_PARENT y';
x0(end+1) = sp.get(2);
testCoords{end+1} = 'SOCKET_JOINT_LOCATION_IN_PARENT z';
