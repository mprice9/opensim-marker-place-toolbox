...
% models{1} = 'A01_passive_FULL_auto_marker_place_RIGID_4dof_base_no_anchor.osim';
% models{2} = 'A01_passive_FULL_auto_marker_place_FLEXION_ONLY_4dof_base_no_anchor.osim';
% models{3} = 'A01_passive_FULL_auto_marker_place_PISTON_ONLY_4dof_base_no_anchor.osim';
% models{4} = 'A01_passive_FULL_auto_marker_place_FLEXION_PISTON_4dof_base_no_anchor.osim';
