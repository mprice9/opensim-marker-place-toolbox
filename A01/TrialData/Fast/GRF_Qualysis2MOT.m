...
% the data in Lab Reference frame. However, it create 5 separate ground
...
Left_plate = [1,0,1,0,1]; %plate 1, 3, 5 belong to left leg

% MOT file output filename:
% mot_filename = '20121109_S07_GRF_walking0001'
% mot_filename = '20121109_S07_GRF_walking0003'
% mot_filename = '20121109_S07_GRF_walking0005'
% mot_filename = '20121109_S07_GRF_walking0007'
% mot_filename = '20121109_S07_GRF_walking0008'
mot_filename = '20130528_ablebiped_GRF_walking001'

f_cut = 20; % cut off force at 20N

% The starting and ending time heel strike and toe off on each plate (Can read-in from file):
% S07, Trial 01.
plate_cut_t = [.55, 1.1;       % plate 1 heel strike and toe off
               0, .707;    % plate 2 heel strike and toe off
               4, 4;    % plate 3 heel strike and toe off
               4, 4;           % plate 4 heel strike and toe off
               4, 4];          % plate 5 heel strike and toe off
% S07, Trial 03.
% plate_cut_t = [1.33, 3;       % plate 3 heel strike and toe off
%                0.725, 1.48;    % plate 2 heel strike and toe off
%                0.138, 0.885;    % plate 1 heel strike and toe off
%                1, 1;           % plate 4 heel strike and toe off
%                1, 1];          % plate 5 heel strike and toe off
% S07, Trial 05.
% plate_cut_t = [1.455, 3;       % plate 3 heel strike and toe off
%                0.906, 1.604;    % plate 2 heel strike and toe off
%                0.359, 1.06;    % plate 1 heel strike and toe off
%                1, 1;           % plate 4 heel strike and toe off
%                1, 1];          % plate 5 heel strike and toe off
% S07, Trial 07.
% plate_cut_t = [1.39, 3;       % plate 3 heel strike and toe off
%                0.832, 1.54;    % plate 2 heel strike and toe off
%                0.28, 0.98;    % plate 1 heel strike and toe off
%                1, 1;           % plate 4 heel strike and toe off
%                1, 1];          % plate 5 heel strike and toe off
% S07, Trial 08.
% plate_cut_t = [1.345, 3;       % Plate 3 heel strike and toe off
%                0.78, 1.485;    % Plate 2 heel strike and toe off
%                0.215, 0.92;    % Plate 1 heel strike and toe off
%                1, 1;           % Plate 4 heel strike and toe off
%                1, 1];          % Plate 5 heel strike and toe off
% S07, BHBK Trial 02.
% plate_cut_t = [1.415, 3;       % Plate 3 heel strike and toe off
%                0.81, 1.545;    % Plate 2 heel strike and toe off
%                0.196, 0.97;    % Plate 1 heel strike and toe off
%                1, 1;           % Plate 4 heel strike and toe off
%                1, 1];          % Plate 5 heel strike and toe off
...
for i = 1:num_plate,
    ...
    elseif max(grf(end-25:end,6*(i-1)+3) <= 5) % if the max of first 25 Fz ptns is less than threshold 5N
        ...
        disp('we got a problem here, cant remove signal base noise');
